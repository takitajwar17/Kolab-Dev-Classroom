...
export default function CoursePage({ params }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="relative h-60 bg-gradient-to-br from-[#1e1e1e] to-[#cf4500]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-end pb-6">
          <h1 className="text-4xl font-medium text-white mb-2">{course.title}</h1>
          <p className="text-white/90 text-xl mb-3">Course Code: {course.courseCode}</p>
          <p className="text-white/80 text-base max-w-3xl">{course.description}</p>
        </div>
      </div>
