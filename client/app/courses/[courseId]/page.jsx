        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-t-lg shadow-sm mb-6 overflow-x-auto">
            <div className="flex px-6 min-w-max">
              <button className="px-4 py-4 text-sm font-medium text-[#cf4500] border-b-2 border-[#cf4500] whitespace-nowrap">
                Stream
              </button>
              <button className="px-4 py-4 text-sm font-medium text-gray-500 hover:text-[#cf4500] whitespace-nowrap">
                Classwork
              </button>
              <button className="px-4 py-4 text-sm font-medium text-gray-500 hover:text-[#cf4500] whitespace-nowrap">
                People
